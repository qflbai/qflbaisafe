...
import com.qflbai.mobilesafe.engine.VirusDao;
...
public class AnitVirusActivity extends Activity {
    ...
    private void checkVirus() {
        new Thread(){
            public void run() {
                ...
                //2.获取所有应用程序签名文件(PackageManager.GET_SIGNATURES
                // 已安装应用的签名文件+)
                //PackageManager.GET_UNINSTALLED_PACKAGES卸载完了的应用,残余的文件
                List<PackageInfo> packageInfoList = pm.getInstalledPackages(
                        PackageManager.GET_SIGNATURES + PackageManager
                ...
                for (PackageInfo packageInfo : packageInfoList) {
                    ...
                    // 1:顶部扫描应用的名称2:扫描过程中往线性布局中添加view)
    ...
    private void initUI() {
        ...
        tv_name = (TextView) findViewById(R.id.tv_scanning_name);
        pb_bar = (ProgressBar) findViewById(R.id.pb_scanning);
