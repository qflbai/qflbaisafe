...
public class AddressService extends Service {
    ...
    private InnerOutCallReceiver mIcr;
    ...
    public void onCreate() {
        ...
        //监听播出电话的广播接受者（动态注册广播事件）
        mFilter = new IntentFilter();
        //注册
        mFilter.addAction(Intent.ACTION_NEW_OUTGOING_CALL);
        //创建 广播接受者
        mIcr = new InnerOutCallReceiver();
        registerReceiver(mIcr, mFilter);
        super.onCreate();
    }
...
//                | WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE	默认能够被触摸
        ...
        mDrawableIds = new int[]{
                R.drawable.call_locate_pink,
                R.drawable.call_locate_orange,
                R.drawable.call_locate_blue,
                R.drawable.call_locate_gray,
                R.drawable.call_locate_green,
                R.drawable.call_locate_purple};
    ...
    public void onDestroy() {
        ...
        //反注册广播事件
        if(mIcr != null){
            unregisterReceiver(mIcr);//取消广播事件
        }
        super.onDestroy();
    }
}
