...
import com.qflbai.mobilesafe.activity.EnterPwdActivity;
...
public class WatchDogService extends Service {
    ...
    public void onCreate() {
        ...
        //注册一个内容观察者,观察数据库的变化,一旦数据有删除或者添加,
        // 则需要让mPacknameList重新获取一次数据
            ...
            public void run() {
                ...
                while(isWatch){
                    ...
                    String packagename = runningTaskInfo.topActivity
                            .getPackageName();
                    Log.i(TAG, "run:"+packagename);
                    //如果任务栈指向应用有切换,将mSkipPackagename空字符串

                    //6.拿此包名在已加锁的包名集合中去做比对,如果包含次包名
                    // 则需要弹出拦截界面
